...
export const technologies: Technology[] = [
  ...
  },
  {
    ...
    category: "Backend",
    description:
      "A fast, minimalist web framework for Node.js used to build APIs and web servers.",
  ...
  },
  {
    ...
    category: "Language",
    description:
      "A readable, general-purpose language widely used for backend, data, and automation work.",
