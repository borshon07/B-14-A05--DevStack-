    ...
    <div className="grid w-full max-w-[1216px] grid-cols-1 gap-8 lg:grid-cols-12">
      <div className="flex flex-col justify-center lg:col-span-7 lg:pr-8">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
          <button className="rounded-lg bg-gradient-to-r from-orange-500 to-pink-500 px-4 py-3 text-sm font-semibold text-white sm:w-[168px]">
            Explore Technologies
          </button>
          <button className="rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 sm:w-[170px]">
            Learn More
          </button>
        </div>
      </div>
